...
class indivisualContact extends StatefulWidget {
  const indivisualContact({super.key});

  @override
  State<indivisualContact> createState() => _indivisualContactState();
}

class _indivisualContactState extends State<indivisualContact> {
        ...
        child: Column(
          children: [
            ...
            Text(
              'Call history',
              style: TextStyle(
                  color: Color.fromARGB(255, 132, 127, 127), fontSize: 15),
            ),
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return const Card(
                    ...
                    subtitle:
                        Text('0334 3417080', style: TextStyle(fontSize: 8)),
                    trailing: Text(
                      'Didn\'t connect ',
